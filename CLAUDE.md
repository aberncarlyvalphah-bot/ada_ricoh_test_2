# Data Ada Agent - Project Instructions
## Project Context
A data analysis and visualization platform with Next.js frontend and ECharts integration.
...
- Implement functionality to satisfy all steps
...
1. **大幅度页面修改**（新建页面、重写组件、修改核心交互）：
   - **必须在浏览器中测试！** 使用 Puppeteer 截图或 MCP Playwright 工具
   - 验证页面能正确加载和渲染
   - 验证表单提交、按钮点击等交互功能
   - 截图确认 UI 正确显示
...
└── data-ada-agent/   # Next.js application
